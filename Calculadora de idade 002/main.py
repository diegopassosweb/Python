...
app_mes = Label(frame_baixo, text='Meses', height=1, padx=0, relief='flat', anchor='center', font=('Ivy 12 bold'),  bg=cor1, fg=cor3)
app_mes.place(x=130, y=175)

app_3_dia = Label(frame_baixo, text='27', padx=0, relief='flat', anchor='center', font=('Ivy 12 bold'), bg=cor1, fg=cor3)
