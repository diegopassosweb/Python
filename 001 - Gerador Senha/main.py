...
b_gerar_senha = Button(frame_box,text="Gerar senha",width=32, height=1, overrelief=SOLID,  bg=co3, fg="white", font=('Ivy 10 bold'), anchor="center", relief=FLAT )
b_gerar_senha.grid(row=5, column=0,  sticky=NSEW, pady=20, padx=0, columnspan=5)


b_copiar = Button(frame_box, text="Copiar",width=7, height=1, overrelief=SOLID,  bg=co1, fg=co0, font=('Ivy 10 bold'), anchor="center", relief=RAISED )
