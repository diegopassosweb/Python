...
# frame cima
app_nome = Label(frame_cima, text='Calculadora de IMC', width=23, height=1, padx=0, pady=0, relief='flat', anchor='center', font=('Ivy, 16 bold'), bg=co0, fg=co1)
app_nome.place(x=0, y=0)

app_linha = Label(frame_cima, text='', width=400, height=1, padx=0, pady=0, relief='flat', anchor='center', font=('Ivy, 1 '), bg=co2, fg=co1)
app_linha.place(x=0, y=35)

# frame baixo

l_peso = Label(frame_baixo, text='Insira seu peso', height=1, padx=3, pady=10, relief='flat', anchor='center', font=('Ivy, 10 bold'), bg=co0, fg=co1)
l_peso.grid(row=0, column=0, sticky=NSEW )

e_peso = Entry(frame_baixo, width=5, relief='solid', justify='center', font=('Ivy, 10 bold'))
e_peso.grid(row=0, column=1, sticky=NSEW, padx=3, pady=10 )

l_altura = Label(frame_baixo, text='Insira sua altura', height=1, padx=3, pady=10, relief='flat', anchor='center', font=('Ivy, 10 bold'), bg=co0, fg=co1)
l_altura.grid(row=1, column=0, sticky=NSEW )

e_altura = Entry(frame_baixo, width=5, relief='solid', justify='center', font=('Ivy, 10 bold'))
