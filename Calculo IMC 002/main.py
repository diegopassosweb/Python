...
app_nome = Label(frame_cima, text='Calculadura de IMC', width=23, height=1, padx=0, relief='flat', anchor='center', font=('Ivy 16 bold'), bg=co0, fg=co1)
...
l_resultado_texto = Label(frame_baixo, text='O seu IMC é: abaixo do peso', width=37 , height=1, padx=0, pady=12, relief='flat', anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co1)
