...
app_nome = Label(frame_cima, text='Calculadora IMC', width=23, height=1, padx=0, relief="flat", anchor="center", font=('Ivy 16 bold'), bg=co1, fg=co0)
...
def calcular():
    ...
    elif resultado >= 18.5 and resultado < 34.9:
