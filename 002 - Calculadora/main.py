...
app_label = Label(frame_tela, textvariable=valor_texto, width=15, height=2, padx=7, relief=FLAT, anchor='e', justify=RIGHT, font=('Ivy 18 bold'), bg=cor3, fg=cor2 )
app_label.place(x=0, y=0)

#botoes

b_1 = Button(frame_corpo, command=limpar_telar, text='C', width=11, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE )
b_1.place(x=0, y=0)
